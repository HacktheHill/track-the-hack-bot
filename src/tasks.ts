...
async function handleModal(interaction: ModalSubmitInteraction, services: Services) {
	...
	const workPackage = await createAndAnnounce({
		...
		projectText: draft?.projectId ? String(draft.projectId) : interaction.fields.getTextInputValue("project") || null,
		assigneeId: draft?.assigneeId ?? (interaction.fields.getTextInputValue("assignee") || undefined),
