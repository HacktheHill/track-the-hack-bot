...
export class Database {
	...
	async pendingProposalsForSourceMessage(messageId: string) {
		// Use @> instead of = ANY() to ensure PostgreSQL uses the GIN index on source_message_ids
		// This converts a potential O(n) full table scan into an O(1) index lookup
